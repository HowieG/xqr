...
//       `${requestUrl.origin}/error?error_description=${supabase_error_description}`,
//     );
//   }
...
//       }
//     } else {
//       const error_description = encodeURIComponent(
//         "No user found after exchanging cookies for registration",
//       );
//       return NextResponse.redirect(
//         `${requestUrl.origin}/error?error_description=${error_description}`,
//       );
//     }
//   }
